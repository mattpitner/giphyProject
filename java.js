$(document).ready(function() {
    ...
    var characters = [
      "Han Solo", "Poe Dameron", "C3PO", "Jar Jar Binks", "Luke Skywalker", "Boba Fett", "Darth Maul"
    ...
    $(document).on("click", ".character-button", function() {
      ...
      var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + type + "&api_key=1jJz0ahfRPIEsEqM1nJcIP3rGKvgFzAw";
